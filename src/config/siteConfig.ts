...
export const siteConfig: SiteConfig = withUserConfig("site", {
	...
	texture: {
		...
		defaultOpacity: 0.1, // 默认纹理浓度 (0.05 ~ 0.25)
	...
	banner: {
		...
		src: {
			desktop: ["assets/images/banner/desktop/DesktopPoster16_9.webp"],
			mobile: ["assets/images/banner/mobile/MobilePoster9_16.webp"],
		},
		...
		homeText: {
			...
			title: "MacrosMeng",
			subtitle: [
				"and the universe said I love you | 而宇宙说，我爱你",
				"and the universe said everything you need is within you | 而宇宙说，你所需的一切你都具有",
				"and the universe said you are stronger than you know |而宇宙说，你比你所知的要强大",
				"and the universe said you are the daylight | 而宇宙说，你就是白昼",
				"and the universe said you are the night | 而宇宙说，你就是黑夜",
				"and the universe said the darkness you fight is within you | 而宇宙说，你所斗争的黑暗就在你心中",
				"and the universe said the light you seek is within you | 而宇宙说，你所追寻的光明就在你心中",
				"and the universe said you are not alone | 而宇宙说，你并非孤身一人\nand the universe said you are not separate from every other thing | 而宇宙说，你并非与万物隔绝",
				"and the universe said you are the universe tasting itself, talking to itself, reading its own code | 而宇宙说，你就是宇宙本身，品尝着自己，对自己说话，阅读着自己的代码",
				"and the universe said I love you because you are love. | 而宇宙说，我爱你，因为你就是爱。",
				"You are the player. | 你就是那个玩家。\nWake up. | 醒来吧。",
				"I see the player you mean.\nMacrosMengQWQ?\nYes. Take care. It has reached a higher level now. It can read our thoughts.\nThat doesn't matter. It thinks we are part of the game.\nI like this player. It played well. It did not give up.\nIt is reading our thoughts as though they were words on a screen.",
				"No. It has not yet achieved the highest level. That, it must achieve in the long dream of life, not the short dream of a game. | 是的，他还没有到达最高的境界。要抵达那层，他必须走完生命的长梦，而非游戏中黄粱一梦。",
				"Too strong for this dream. To tell them how to live is to prevent them living. | 这个梦对于他们来说太深刻了。告诉他们怎么活就是在束缚他们自由地活着。",
				"And the player was a new story, never told before, written in letters of DNA. And the player was a new program, never run before, generated by a sourcecode a billion years old. And the player was a new human, never alive before, made from nothing but milk and love. | 那个玩家由DNA的语言书写，是一个尚未讲述的全新故事。那个玩家由上亿年的源代码生成，是一个尚未运行的全新程序。那个玩家仅由奶和爱组成，是一个尚未生活的全新人类。\nYou are the player. The story. The program. The human. Made from nothing but milk and love. | 你就是那个玩家。那个故事。那个程序。那个人类。仅由奶和爱组成。",
				"You. You. You are alive. | 你。你。你是活着的。",
				"智在知互 思于识通 | Wisdom in exchange, insight in synthesis.",
			],
			typewriter: {
